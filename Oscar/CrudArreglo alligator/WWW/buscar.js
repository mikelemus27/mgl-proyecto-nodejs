...
commands.writeEscapedText("%09%3CBODY%20bgcolor%3D%22gray%22%3E%0D%0A");
commands.writeEscapedText("%09%09");
		  var x= lib.Vista;
		  var y=new x.Vista();
		commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%09%0D%0A");
commands.writeEscapedText("%09%09");commands.write(y.Busqueda(request.parameters.gpradios,request.parameters.txtVALOR));commands.writeEscapedText("%0D%0A");
...
commands.writeEscapedText("%09%09%3CINPUT%20name%3D%22btnINDICADOR%22%20type%3D%22submit%22%20value%3D%22Menu%20Principal%22%20%20%20/%3E%0D%0A");
