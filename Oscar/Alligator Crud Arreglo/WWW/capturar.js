...
commands.writeEscapedText("%09%09");
		  var x= lib.Vista;
		  var y=new x.Vista();
		  y.Capturar(request.parameters.txtCLAVE,request.parameters.txtNOMBRE,request.parameters.txtMODULOS,request.parameters.txtCREDITOS,request.parameters.txtPERIODO);
