...
commands.writeEscapedText("%09%09");commands.write("<head><title>Buscar_Dato</title></head>");commands.writeEscapedText("%0D%0A");
...
commands.writeEscapedText("%09%09");commands.write(y.BuscarDato(request.parameters.txtDato));commands.writeEscapedText("%0D%0A");
