...
commands.writeEscapedText("%09%09");commands.write("<head><title>Guardar</title></head>");commands.writeEscapedText("%0D%0A");
...
commands.writeEscapedText("%09%09");
		  var x= lib.cargarModeloArchivo;
		  var y=new x.cargarModeloArchivo();
		commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%09");commands.write(y.GuardarDatos(request.parameters.txtNombre,request.parameters.txtTipo,request.parameters.txtRecurso,request.parameters.txtTiempo,request.parameters.txtMateria));commands.writeEscapedText("%0D%0A");
