...
commands.writeEscapedText("%09%09");commands.write(y.Capturar(request.parameters.carrera,request.parameters.creditos,request.parameters.clave,request.parameters.area,request.parameters.tipo));commands.writeEscapedText("%0D%0A");
