...
commands.writeEscapedText("%09%09%0D%0A");
commands.writeEscapedText("%09%09");}else if(request.parameters.button == "Actualizar"){commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%09"); commands.sendRedirect("./modificar.jssp");commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%09%0D%0A");
commands.writeEscapedText("%09%09");}else if(request.parameters.button == "Eliminar"){commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%09"); commands.sendRedirect("./eliminar.jssp");commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%0D%0A");
