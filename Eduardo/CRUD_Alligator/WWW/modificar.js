...
commands.writeEscapedText("%09%09");commands.write("<head><title>Modificar</title></head>");commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%3CBODY%20bgcolor%3D%22%234C0B5F%22%3E%0D%0A");
commands.writeEscapedText("%20%0D%0A");
commands.writeEscapedText("%09%09");
		  var x= lib.Vista;
		  var y=new x.Vista();
		commands.writeEscapedText("%0D%0A");
commands.writeEscapedText("%09%09");commands.write(y.Editar());commands.writeEscapedText("%0D%0A");
